    ...
    const client = createClient({
      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            // Fetch the Contentful entry by its ID
            const entry = await client.getEntry('6mbhcNH8cnZ24MQQgnu0y4');
            
            // Access the "fields" object and then the "whoweare" field
            const whoweareValue = entry.fields.whoweare;
    
            // Update state with the whoweareValue
    ...
    const [Blogs, setBlogs] = useState([]);
      ...
      useEffect(() => {
        ...
        var client = contentful.createClient({
          ...
          accessToken: "xi7Tx42qAvqrhAg44MvzCtojHOrNgUHkHrlQMSOhb3M-doiF7gp5-zb5QZ0sQ",
        });
    
        client
          .getEntries({ content_type: "author" })
          .then((entries) => setBlogs(entries.items))
          .catch(console.error);
        console.log();
      }, []);
      console.log(Blogs);
...
the globe. Explore the garden of fabrics. imagination forever be in full bloom! </p>
                ...
                <div className="flex mt-32 justify-center">
                    <div className="">
                      ...
                      <img  className="w-[400px] h-[500px]" src="/ach9.jpg" alt=""/>
                    </div>
...
being part of this journey. Together, let’s weave our dreams. </p>
                ...
                <div className="   h-[100px] bg-purple-400   mt-20 ">
            <div className=" ">
